...
def parse_command_line():
    ...
    # 经常需要修改
    parser.add_argument("--learning_rate", "-lr", type=float, default=0.000001, help="Learning rate.")
    ...
    parser.add_argument('--test_iters', nargs='+', type=int, default=[14000,16000,18000, 20000], help='iterations to test at. Default is for ssv2 otam split.')
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=14000, help="Path to model to load and test.")
    ...
    parser.add_argument('--dist_direction', default='up2down', help='distillation direction')  #bid up2down down2up
    parser.add_argument('--dist_condition', type=int, default=[1, 0],  help='distillation condition') #t-compare, v-compare  #这 3*2*2 一共是12种组合

    parser.add_argument('--single_view', default='both', help='distillation condition')  # gtce, ltce, ntce, both, 如果这里选择的单分支 则lambdas最后一位必须是零
